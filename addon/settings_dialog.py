...
_SETTINGS = {
    ...
    "Word Text": [
        ...
        ("--word-autoplay", "Word Autoplay", ["front only", "back only", "front & back", "when no def audio", "details", "none"], "front & back"),
    ...
    "Sentence Text": [
        ...
        ("--sentence-autoplay", "Sentence Autoplay", ["front only", "back only", "front & back", "when no def audio", "details", "none"], "front & back"),
    ...
    "Definitions": [
        ...
        ("--definition-secondary", "Secondary Definition Text", ["on", "off", "details", "separate toggle"], "separate toggle"),
