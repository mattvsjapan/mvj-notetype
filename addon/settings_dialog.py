...
_SETTINGS = {
    ...
    "Word Text": [
        ...
        ("--word-autoplay", "Word Autoplay", ["front only", "back only", "front & back", "details", "none"], "front & back"),
    ...
    "Sentence Text": [
        ...
        ("--sentence-autoplay", "Sentence Autoplay", ["front only", "back only", "front & back", "details", "none"], "front & back"),
    ...
    "Definitions": [
        ...
        ("--definition-text", "Primary Definition Text", ["on", "details", "off"], "on"),
        ("--definition-secondary", "Secondary Definition Text", ["on", "off", "details", "toggle"], "toggle"),
        ("--definition-audio", "Definition Audio", ["on", "details", "off"], "on"),
        ("--definition-audio-buttons", "Definition Audio Buttons", ["on", "off"], "on"),
        ("--definition-autoplay-bi", "Definition Autoplay (Bilingual)", ["always", "only when primary", "primary or reveal", "off"], "always"),
        ("--definition-autoplay-mono", "Definition Autoplay (Monolingual)", ["always", "only when primary", "primary or reveal", "off"], "always"),
...
class SettingsDialog(QDialog):
    ...
    def _build_ui(self) -> None:
        ...
        for btn in (self._btn_add, self._btn_del, self._btn_up, self._btn_down):
            ...
            btn.setStyleSheet("QPushButton { padding: 2px 0px; }")
